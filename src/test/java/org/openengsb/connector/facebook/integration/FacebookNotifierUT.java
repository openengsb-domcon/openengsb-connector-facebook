...
public class FacebookNotifierUT {
    ...
    @Test
    public void testToSendAFacebookMsgWithSSL_shouldWork() throws Exception {
    ...
    @Test
    public void testToSendAFacebookMsgWithTLS_shouldWork() throws Exception {
    ...
    @Test
    public void testChangeFacebookProperties_shouldWork() {
        FacebookNotifier notifier = createStartTlsNotifier();
        Notification notification = createNotification();
        notifier.notify(notification);
    ...
    private FacebookNotifier createNotifier(String id, String userID, String userToken) {
        FacebookAbstraction facebookAbstraction = new JavaxFacebookAbstraction();
