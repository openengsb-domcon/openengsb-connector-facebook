...
public class FacebookNotifierTest {
    ...
    @Test
    public void testToSendAnFacebook() throws Exception {
        FacebookAbstraction mailMock = mock(FacebookAbstraction.class);
        ...
        verify(mailMock).send(propertiesMock, "Content");
    }
    ...
    public void testThatDomainMethodExecutionExceptionIsThrown() throws Exception {
        ...
        FacebookProperties propertiesMock = mock(FacebookProperties.class);
        when(mailMock.createFacebookProperties()).thenReturn(propertiesMock);
        FacebookNotifier notifier = new FacebookNotifier("", mailMock);

        Notification notificationMock = mock(Notification.class);

        doThrow(new DomainMethodExecutionException()).when(mailMock).send(any(FacebookProperties.class), anyString());
